                      ...
                      <div className="w-full md:w-9/12 mx-2 h-64">
                        ...
                        <span className="text-green-500">
                            <svg className="h-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                              ...
                              <div className="text-gray-700 dark:text-gray-200">
                                  <div className="grid md:grid-cols-2 text-sm">
                                      ...
                                      <div className="grid grid-cols-2">
                                          ...
                                          <div className="px-4 py-2">Basket Ball</div>
                                      </div>
                                      <div className="grid grid-cols-2">
                              ...
                              <button
                                  className="block w-full text-blue-800 text-sm font-semibold rounded-lg hover:bg-gray-100 dark:hover:bg-secondary-3 focus:outline-none focus:shadow-outline focus:bg-gray-100 hover:shadow-xs p-3 my-4">
